module.exports = function MessageGenerator() {
  ...
  const ACTIVATE__DIGITAL_MOTOR_FUNCTION_NUMBER = "2";
  const ACTIVATE_ANALOG_MOTOR_FUNCTION_NUMBER = "3";
  const ANALOG_READ_FUNCTION_NUMBER = "4";
  const DIGITAL_READ_FUNCTION_NUMBER = "5";
  const INITIALIZE_DIGITAL_INPUT_FUNCTION_NUMBER = "6";
  const PIN_MODE_FUNCTION_NUMBER = "7";
  const DIGITAL_WRITE_FUNCTION_NUMBER = "8";
  const ANALOG_WRITE_FUNCTION_NUMBER = "9";
  ...
  this.analogRead = function(pin) {
    ...
    var message = [ANALOG_READ_FUNCTION_NUMBER, pin, TERMINAL];
    return message.join(SEPARATOR);
  ...
  this.digitalRead = function(param) {
    ...
    var message = [DIGITAL_READ_FUNCTION_NUMBER, pin, TERMINAL];
    return message.join(SEPARATOR);
  };
